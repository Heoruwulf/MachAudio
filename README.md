...
* **Debian/Ubuntu:** `sudo apt-get install cmake gcc clang clang-tools liburing-dev libuv1-dev`
* **Alpine:** `apk add cmake gcc clang clang-extra-tools musl-dev liburing-dev libuv-dev`
